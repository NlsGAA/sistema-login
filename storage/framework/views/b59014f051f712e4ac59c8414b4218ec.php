    ...
    <div class="container">
        ...
        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="user-card">
                ...
                <button class="collapse-btn" onclick="togglePermissions(<?php echo e($user['id']); ?>)">
                    Ver Permissões
                </button>
                ...
                <form action="<?php echo e(route('delete-user', $user['id'])); ?>" onsubmit="return confirm('Tem certeza que deseja excluir este usuário?')">
                    <?php echo csrf_field(); ?>
                ...
                <div class="permissions-container" id="permissions-<?php echo e($user['id']); ?>">
                    <fieldset disabled style="border: none">
                        <form action="<?php echo e(route('toggle-permissions')); ?>" method="POST">
                            ...
                            <ul class="permissions-list">
                                <?php $__currentLoopData = $user['permissions']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="permission-item">
                                        <input type="checkbox" id="permission-<?php echo e($permission['permission_name']); ?>" name="permissions[]" value="<?php echo e($permission['id']); ?>" <?php echo e($permission['has_permission'] ? 'checked' : ''); ?>>
                                        <label for="permission-<?php echo e($permission['permission_name']); ?>"><?php echo e($permission['permission_name']); ?></label>
                                    </li>
...
<?php /**PATH C:\Users\Nico\Documents\Programação\testes\permission\resources\views\permissions.blade.php ENDPATH**/ ?>